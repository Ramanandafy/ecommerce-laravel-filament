            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="email-error">Desolé verifier votre adresse email</p>
                </div>
                <!-- End Form Group -->
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="password-error">le mot de passe est au moins 8 caractère</p>
                </div>
                <!-- End Form Group -->
