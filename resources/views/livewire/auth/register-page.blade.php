            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="email-error">Votre adresse email est invalider</p>
                </div>
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="password-error">au moins 8 caractère</p>
                </div>
                <!-- End Form Group -->
