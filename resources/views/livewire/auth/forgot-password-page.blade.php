        ...
        <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            <div class="text-center">
              <h1 wire:navigate class="block text-2xl font-bold text-gray-800 dark:text-white">mot de passe oublier?</h1>
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Oubler votre mot de passe?
              ...
              <form>
                <div class="grid gap-y-4">
                  ...
                  <div>
                    ...
                    <p class="hidden text-xs text-red-600 mt-2" id="email-error">Verifier votre adresse email</p>
                  </div>
                  <!-- End Form Group -->
                  <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Mot de passe oublier</button>
                </div>
              </form>
              <!-- End Form -->
            </div>
