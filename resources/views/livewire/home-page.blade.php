  ...
  <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
<<<<<<< HEAD
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Lancez votre expérience avec <span class="text-blue-600">DCodeEdson</span></h1>
          <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Explorez une large sélection de produits électroniques : smartphones, ordinateurs portables, montres connectées, téléviseurs et bien plus encore, au meilleur prix. »</p>
=======
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-black">Start your journey with <span class="text-blue-600">DCodeEdson</span></h1>
    ...
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-black-200"> Browse Popular<span class="text-blue-500"> Produit
            </span> </h1>
...
<<<<<<< HEAD
        <p class="mb-12 text-base text-center text-gray-500">
          « Bienvenue sur notre plateforme dédiée aux pierres précieuses. Explorez une sélection unique de produits authentiques,
          alliant qualité, élégance et savoir-faire. Trouvez la pièce idéale qui correspond à votre style. »
=======
...
>>>>>>> 6199dbd47235a6029bf3fc25afc556ec8696c8ac
    ...
    <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key= "{{ $marque->id }}">
            <a href="/produits?selected_marques[0]={{ $marque->id }}" class="">
              <img src="{{ url('storage', $marque->image) }}"
              alt="{{ $marque->name }}" class="object-cover w-full h-64 rounded-t-lg">
            </a>
...
<div class="bg-orange-200 py-20">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-black-200"> Browse <span class="text-blue-500"> Categories
            </span> </h1>
          <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
            <div class="flex-1 h-2 bg-blue-200">
            </div>
...
<a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/produits?selected_categories[0]={{ $categorie->id }}" wire:key="{{ $categorie->id }}">
    <div class="p-4 md:p-5">
      <div class="flex justify-between items-center">
        <div class="flex items-center">
          <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ url('storage', $categorie->image) }}" alt="{{ $categorie->name }}">
          <div class="ms-3">
...
<section class="py-14 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
      <div class="max-w-xl mx-auto">
        <div class="text-center ">
          <div class="relative flex flex-col items-center">
            <h1 class="text-5xl font-bold dark:text-gray-200"> Avis de <span class="text-blue-500"> Client
              </span> </h1>
            <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
              <div class="flex-1 h-2 bg-blue-200">
              </div>
        ...
        <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
            ...
            <div class="flex items-center px-6 mb-2 md:mb-0 ">
              ...
              <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                  Edson Ramanandafy</h2>
                <p class="text-xs text-gray-500 dark:text-gray-400">Web Designer</p>
              </div>
            </div>
            <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Creation
            </p>
          </div>
          <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
           « Nous vous proposons une sélection de pierres précieuses authentiques, choisies avec soin pour garantir qualité et satisfaction.
            Trouvez facilement le produit qui correspond à vos attentes. »
          </p>
          <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
            <div class="flex px-6 mb-2 md:mb-0">
              ...
              <h2 class="text-sm text-gray-500 dark:text-gray-400">Avis clients:<span class="font-semibold text-gray-600 dark:text-gray-300">
                  3.0</span>
              </h2>
            </div>
        ...
        <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
          <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
            <div class="flex items-center px-6 mb-2 md:mb-0 ">
              ...
              <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-300">
                   Edson Ramanandafyk</h2>
                <p class="text-xs text-gray-500 dark:text-gray-400">Programmer</p>
              </div>
            </div>
            <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> creation
            </p>
